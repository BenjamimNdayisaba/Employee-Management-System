...
const quickLinks = [
  ...
  { to: "/dashboard/submissions", label: "Project Submissions" },
];
          ...
          <div className="card shadow-sm h-100">
            <div className="card-header bg-white">
              <div className="d-flex justify-content-between align-items-center">
                ...
                <Link to="/dashboard/tasks" className="btn btn-sm btn-outline-primary">
                  View tasks
                </Link>
              </div>
            </div>
        ...
        <div className="col-12">
          <div className="card shadow-sm">
            ...
            <div className="card-body d-flex flex-wrap gap-2">
              {quickLinks.map((q) => (
                <Link key={q.to} to={q.to} className="btn btn-outline-secondary">
                  {q.label}
                </Link>
              ))}
            </div>
